...
// This file should be renamed to GameEventHighlight.tsx
// For the purpose of this tool, I will provide the content for the new name.
// Please ensure the file is actually renamed in your project structure from
// FuriaGameHighlight.tsx to GameEventHighlight.tsx
...
export function GameEventHighlight({ game, className }: GameEventHighlightProps) {
